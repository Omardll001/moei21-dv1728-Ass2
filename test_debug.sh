...
for testid in "${!tests[@]}"; do 
    ...
    echo "DEBUG: sumLine='$sumLine'"
    echo "DEBUG: T1status='$T1status'"
    echo "DEBUG: T1gitstr='$T1gitstr'"
    echo "DEBUG: T1randstr='$T1randstr'"
    echo "DEBUG: expected gitString='$gitString'"
    echo "DEBUG: expected randValue='$randValue'"
